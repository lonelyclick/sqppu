...
/**
 * RequestSimParent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestSimParent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestSimParent';
     ...
     *
     * @param int $parent_group_id The unique identifier of the new parent group
     *
     * @return $this
     */
