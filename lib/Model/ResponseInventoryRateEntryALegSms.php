...
/**
 * ResponseInventoryRateEntryALegSms Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseInventoryRateEntryALegSms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseInventoryRateEntryALegSms';
...
'mt_rate' => 'getMtRate'    ];
     ...
     * Sets mo_rate
     *
     * @param float $mo_rate The rate charged per sent SMS
     *
     * @return $this
     */
     ...
     * Sets mt_rate
     *
     * @param float $mt_rate The rate charged per received SMS
     *
     * @return $this
     */
