...
/**
 * RequestImsiWhitelist Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestImsiWhitelist implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestImsiWhitelist';
     ...
     * Sets whitelist_id
     *
     * @param int $whitelist_id The Whitelist ID that needs to be updated for IMSI
     *
     * @return $this
     */
