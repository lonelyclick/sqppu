...
/**
 * RequestGroupParent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestGroupParent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestGroupParent';
     ...
     *
     * @param int $parent_group_id The unique identifier of the new parent group, if null, then set the parent to its inventory
     *
     * @return $this
     */
