...
/**
 * ResponseDataCdrCost Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseDataCdrCost implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseDataCdrCost';
...
'package_usage_byte' => 'int',
'rate_cent_per_mb' => 'float',
'charge_cent' => 'float'    ];
...
'package_usage_byte' => 'int64',
'rate_cent_per_mb' => null,
'charge_cent' => null    ];
...
'package_usage_byte' => 'packageUsageByte',
'rate_cent_per_mb' => 'rateCentPerMb',
...
'package_usage_byte' => 'setPackageUsageByte',
'rate_cent_per_mb' => 'setRateCentPerMb',
...
'package_usage_byte' => 'getPackageUsageByte',
'rate_cent_per_mb' => 'getRateCentPerMb',
'charge_cent' => 'getChargeCent'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['package_usage_byte'] = isset($data['package_usage_byte']) ? $data['package_usage_byte'] : null;
        $this->container['rate_cent_per_mb'] = isset($data['rate_cent_per_mb']) ? $data['rate_cent_per_mb'] : null;
    ...
    /**
     * Gets package_usage_byte
     *
     * @return int
     */
    public function getPackageUsageByte()
    {
        return $this->container['package_usage_byte'];
    }

    /**
     * Sets package_usage_byte
     *
     * @param int $package_usage_byte package_usage_byte
     *
     * @return $this
     */
    public function setPackageUsageByte($package_usage_byte)
    {
        $this->container['package_usage_byte'] = $package_usage_byte;

        return $this;
    }

    /**
     * Gets rate_cent_per_mb
     *
     * @return float
     */
    public function getRateCentPerMb()
    {
        return $this->container['rate_cent_per_mb'];
    }

    /**
     * Sets rate_cent_per_mb
     *
     * @param float $rate_cent_per_mb rate_cent_per_mb
     *
     * @return $this
     */
    public function setRateCentPerMb($rate_cent_per_mb)
    {
        $this->container['rate_cent_per_mb'] = $rate_cent_per_mb;
