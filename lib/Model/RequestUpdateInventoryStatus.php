...
/**
 * RequestUpdateInventoryStatus Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestUpdateInventoryStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestUpdateInventoryStatus';
...
const INVENTORY_STATUS_NOT_ACTIVATED = 'NOT_ACTIVATED';
const INVENTORY_STATUS_DE_ACTIVATED = 'DE_ACTIVATED';
...
self::INVENTORY_STATUS_NOT_ACTIVATED,
self::INVENTORY_STATUS_DE_ACTIVATED,        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['inventory_status'] === null) {
            $invalidProperties[] = "'inventory_status' can't be null";
        }
     ...
     *
     * @param string $inventory_status The new status for the Inventory
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getInventoryStatusAllowableValues();
        if (!in_array($inventory_status, $allowedValues, true)) {
