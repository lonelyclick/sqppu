...
/**
 * RequestWhitelist Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestWhitelist implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestWhitelist';
...
'entries' => '\Swagger\Client\Model\RequestWhitelistEntry[]'    ];
...
'entries' => 'getEntries'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['parent_whitelist_id'] === null) {
            $invalidProperties[] = "'parent_whitelist_id' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name name of the whitelist
     *
     * @return $this
     */
     ...
     *
     * @param int $parent_whitelist_id Id of the parent whitelist
     *
     * @return $this
     */
     ...
     * Gets entries
     *
     * @return \Swagger\Client\Model\RequestWhitelistEntry[]
     */
     ...
     * Sets entries
     *
     * @param \Swagger\Client\Model\RequestWhitelistEntry[] $entries The whitelist entries to update
     *
     * @return $this
     */
