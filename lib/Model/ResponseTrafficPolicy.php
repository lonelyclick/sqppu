...
/**
 * ResponseTrafficPolicy Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseTrafficPolicy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseTrafficPolicy';
...
'description' => 'getDescription'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['traffic_policy_id'] === null) {
            $invalidProperties[] = "'traffic_policy_id' can't be null";
        }
     ...
     *
     * @param int $traffic_policy_id The unique identifier of a traffic policy
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description The description of a traffic policy
     *
     * @return $this
     */
